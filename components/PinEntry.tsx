  ...
  return (
    <div className="min-h-screen bg-white flex flex-col">
      ...
      <div className="flex-1 px-6 pt-10">
        <p className="text-slate-700 text-base mb-6 text-center">Enter the upload PIN to continue.</p>
        <input
          type="password"
          inputMode="numeric"
          value={pin}
          ...
          className="w-full border-2 border-slate-300 rounded-2xl px-5 py-4 text-2xl text-slate-800 text-center tracking-widest placeholder:text-slate-400 focus:outline-none focus:border-slate-400 mb-4"
          autoFocus
        />
